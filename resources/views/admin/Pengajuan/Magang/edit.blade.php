...
@section('content')
<h3>Edit Pengajuan Magang</h3>

<form action="{{ route('admin.pengajuan.magang.update', $pengajuan->id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="border p-3 mb-3 rounded">
                <label>NIM:</label>
                <input type="text" class="form-control" name="nim" value="{{ old('nim', $pengajuan->nim) }}" required>
            </div>

            <div class="border p-3 mb-3 rounded">
                <label>Program Studi:</label>
                <input type="text" class="form-control" name="program_studi" value="{{ old('program_studi', $pengajuan->program_studi) }}" required>
            </div>
